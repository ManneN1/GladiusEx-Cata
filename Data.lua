...
function GladiusEx:GetSpecList()
    return {
        ...
        [GladiusEx:SafeGetSpellName(49222)] = 250,      -- Bone Shield
...
function GladiusEx:GetDefaultImportantAuras()
    return {
        ...
        [GladiusEx:SafeGetSpellName(60192)] = 9, -- Freezing Arrow Effect
        ...
        [GladiusEx:SafeGetSpellName(49016)] = 8.8, -- Unholy Frenzy
        ...
        [GladiusEx:SafeGetSpellName(48505)] = 2.5, -- Starfall
...
GladiusEx.auraDurations = {
    ...
    [6789]  = 3,   -- Death Coil
    [90337] = 2.5, -- Bad Manner (Monkey Pet)
