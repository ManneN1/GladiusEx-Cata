...
local function GetDefaultImportantAuras()
	return {
        ...
        [GladiusEx:SafeGetSpellName(85388)] = 9, -- Throwdown
        ...
        [GladiusEx:SafeGetSpellName(89766)] = 9, -- Axe Toss
        [GladiusEx:SafeGetSpellName(93986)] = 9, -- Aura of Foreboding
        ...
        [GladiusEx:SafeGetSpellName(76780)] = 9, -- Bind Elemental
        [GladiusEx:SafeGetSpellName(76577)] = 9, -- Smoke Bomb
        ...
        [GladiusEx:SafeGetSpellName(87204)] = 9, -- Sin and Punishment
        ...
        [GladiusEx:SafeGetSpellName(83047)] = 9, -- Improved Polymorph
        ...
        [GladiusEx:SafeGetSpellName(91797)] = 9, -- Monstrous Blow
        ...
        [GladiusEx:SafeGetSpellName(89488)] = 8.3, -- Strength of Soul
        ...
        [GladiusEx:SafeGetSpellName(87194)] = 5, -- Paralysis
        [GladiusEx:SafeGetSpellName(55080)] = 5, -- Shattered Barrier
        [GladiusEx:SafeGetSpellName(83302)] = 5, -- Improved Cone of Cold
        ...
        [GladiusEx:SafeGetSpellName(68992)] = 1, -- Darkflight
...
function ClassIcon:ScanAuras(unit)
	...
	for index = 1, 40 do
		...
		local isBestPrio, prio = self:handle_aura(unit, name, best_priority)
        if isBestPrio then
            best_priority = prio
            best_name = name
            best_icon = icon
...
function ClassIcon:UpdateAura(unit, iname, iicon, iduration, iexpires, ipriority)
    ...
    if ipriority and ipriority > priority then
        name = iname
        icon = iicon
        duration = iduration
        expires = iexpires
